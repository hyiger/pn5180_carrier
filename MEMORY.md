...
13. **3D models** (2026-09-05, owner's request): KiCad 10 ships no 3D model for any
    ...
    (8.1 × 7.05 × ~6.5, height estimated), XIAO ESP32C6 on the Würth 8.5 mm sockets
    (USB-C over the +X end), MP1584EN module (22.1 × 16.8 × 1.2 PCB, inductor, IC, pot,
    caps), Littelfuse NANO2 451/453 (6.1 × 2.69 × 2.69). Referenced from carrier.pretty;
    J10 and F1 got project-local copies of the stock footprints that differ only in the
    model path, and their Footprint fields now say `carrier:`. The PCB's embedded
